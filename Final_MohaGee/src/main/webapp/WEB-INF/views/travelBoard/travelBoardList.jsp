        ...
        <div class="container">
            ...
            <div class="row">
                <ul class="masonery-filter text-center">
                    ...
                    <li><a class="btn btn-default" href="#" data-filter=".branded">국내</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".design">아시아</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".folio">미주</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".logos">유럽</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".mobile">오세아니아</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".mockup">아프리카</a></li>
                </ul><!--/#portfolio-filter-->
                <div class="masonery-items masonery_area">
                        <div class="col-md-3 col-sm-4 masonery-item branded mobile">
                            <div class="single-blog two-column">
                                <div class="post-thumb">
                                    <a href="TravelBoardDetail.do">
