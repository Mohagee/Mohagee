...
<body>
    ...
    <section id="portfolio" class="padding-top padding-bottom">
        <div class="container">
             ...
             <a href="${ pageContext.request.contextPath }/gotoboardInsertForm.do">
            ...
            <div class="row">
                <ul class="masonery-filter text-center">
                    ...
                    <li><a class="btn btn-default" href="#" data-filter=".branded">대극장</a></li>
                ...
                <div class="masonery-items masonery_area">
                        <div class="col-md-3 col-sm-4 masonery-item branded mobile">
                            <div class="single-blog two-column">
                                <div class="post-thumb">
                                    <a href="${ pageContext.request.contextPath }/gotoshowDetail.do">
                        ...
                        <div class="col-md-3 col-sm-4 masonery-item branded logos">
                            <div class="single-blog two-column">
                                <div class="post-thumb">
									<a href="${ pageContext.request.contextPath }/gotoshowDetail.do">
                                    <img src="${ pageContext.request.contextPath }/resources/images/blog/masonary/6.jpg" class="img-responsive" alt=""></a>
                                    <div class="post-overlay">
                                        <span class="uppercase"><a href="#">14 <br><small>Feb</small></a></span>
                                    </div>
                                </div>
